...
- The difference between Relational Databases and SQL is that a Relational Database's differing tables relate to one another. SQL (Structure Query Language) is used to manage Relational Databases.

2. Why do tables need a `primary key`?
- To easily select specific data and to know what another table's data can point to.
...
- You will need a `JOIN` query in order to join another table. The table being joined needs to have a foreign key.
